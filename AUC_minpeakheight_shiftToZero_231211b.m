...
for k = 1:numCols
    ...
    while Continue == 1
        ...
        Stim1 = data(83:177,k);
        [pks1,locs1,widths,proms] = findpeaks(data(83:177,k),Fs,'MinPeakProminence',UseProms,'WidthReference','halfprom','MinPeakHeight',0.02)  %find peaks > 3 std for individual trace
        ...
        [pks2,locs2,widths,proms] = findpeaks(data(173:266,k),Fs,'MinPeakProminence',UseProms,'WidthReference','halfprom','MinPeakHeight',0.02)  %find peaks > 3 std for individual trace
        ...
        [pks3,locs3,widths,proms] = findpeaks(Stim3,Fs,'MinPeakProminence',UseProms,'WidthReference','halfprom','MinPeakHeight',0.02)  %find peaks > 3 std for individual trace
        ...
        [pks4,locs4,widths,proms] = findpeaks(Stim4,Fs,'MinPeakProminence',UseProms,'WidthReference','halfprom','MinPeakHeight',0.02)  %find peaks > 3 std for individual trace
        ...
        [pks5,locs5,widths,proms] = findpeaks(Stim5,Fs,'MinPeakProminence',UseProms,'WidthReference','halfprom','MinPeakHeight',0.02)  %find peaks > 3 std for individual trace
        ...
        [pks6,locs6,widths,proms] = findpeaks(Stim6,Fs,'MinPeakProminence',UseProms,'WidthReference','halfprom','MinPeakHeight',0.02)  %find peaks > 3 std for individual trace
        ...
        [pks7,locs7,widths,proms] = findpeaks(Stim7,Fs,'MinPeakProminence',UseProms,'WidthReference','halfprom','MinPeakHeight',0.02)  %find peaks > 3 std for individual trace
        ...
        [pks8,locs8,widths,proms] = findpeaks(Stim8,Fs,'MinPeakProminence',UseProms,'WidthReference','halfprom','MinPeakHeight',0.02)  %find peaks > 3 std for individual trace
        ...
        [pks9,locs9,widths,proms] = findpeaks(Stim9,Fs,'MinPeakProminence',UseProms,'WidthReference','halfprom','MinPeakHeight',0.02)  %find peaks > 3 std for individual trace
