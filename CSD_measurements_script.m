...
figure
tiledlayout(ROItotal,2, 'TileSpacing','compact','Padding','compact')
...
for i=1:6
    ...
    CSDbegThreshold = find(SmoothRaw(:,1)>=(10*std(base)),1, 'first')
    ...
    plot(SmoothRaw,'bo','MarkerSize',10,'linewidth',2,'MarkerIndices',(CSDlengthframes + indices))
    plot(SmoothRaw,'bo','MarkerSize',10,'linewidth',2,'MarkerIndices',CSDbeg)
    hold off
