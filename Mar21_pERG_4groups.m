...
n=26 %enter total number of files to be included in analysis
M=cell(n,4)
...
%update numbers inside curly brackets
G2all=horzcat(M{5},M{6},M{7},M{8},M{9},M{10})
...
%update numbers inside curly brackets
G3all=horzcat(M{11},M{12},M{13},M{14},M{15},M{16},M{17},M{18})
...
%update numbers inside curly brackets
G4all=horzcat(M{19},M{20},M{21},M{22},M{23},M{24},M{25},M{26})
...
GroupstatsAmplitude=[G1amp,G2amp,G3amp,G4amp]
