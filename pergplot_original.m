...
G3all=horzcat(G3_tbi_ntsc_pg1Afold, G3_tbi_ntsc_pg1Bfold, G3_tbi_ntsc_pg2Afold, G3_tbi_ntsc_pg2Bfold, G3_tbi_ntsc_pg3Afold, G3_tbi_ntsc_pg3Bfold, G3_tbi_ntsc_pg8Afold, G3_tbi_ntsc_pg8Bfold, G3_tbi_ntsc_pg9Afold, G3_tbi_ntsc_pg9Bfold)

G1sem=std(G1all,0,2)/sqrt(length(G1all))

G1std=std(G1all,0,2)

G1stdplot=horzcat((avgG1all-G1std),avgG1all,(avgG1all+G1std))

G1semplot=horzcat((avgG1all-G3sem),avgG1all,(avgG3all+G3sem))
...
G3stdplot=horzcat((avgG3all-G3stdtest),avgG3all,(avgG3all+G3stdtest))

G3semplot=horzcat((avgG3all-G3semtest),avgG3all,(avgG3all+G3semtest))

avgG3all=mean(G3all,2)

[avgG3allmin,idx]=min(avgG3all,[],1)

idx=minidx

[avgG3allmax,idx]=max(avgG3all,[],1)
